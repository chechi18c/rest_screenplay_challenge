...
/**
 * Utility class for retrieving environment-specific configuration properties
 * defined in Serenity's
 * 'serenity.conf' file. This class provides methods to access properties like
 * base URLs and custom
...
public class EnvironmentConfig {
    ...
    /**
     * Initializes a static instance of {@link EnvironmentVariables} to access
     * system and
    ...
    /**
     * Retrieves the base URL for the currently active environment. The 'base.url'
     * property is
     * typically defined within the 'environments' section of the 'serenity.conf'
     * file (e.g.,
    ...
    /**
     * Retrieves a custom property from the Serenity environment configuration. This
     * method allows
