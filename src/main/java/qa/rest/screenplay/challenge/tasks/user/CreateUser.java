...
/**
 * A Serenity BDD {@link Task} to register a new user in the system. This task
 * encapsulates the API
 * interaction for user registration, constructing a POST request with the
 * {@link
 * CreateUserRequest} payload containing the new user's details. It is designed
 * to be used within
...
public class CreateUser implements Task {
    ...
    /**
     * Constructs a {@code RegisterUser} task with the specified user session
     * request payload.
     *
     * @param createUserRequest The {@link CreateUserRequest} containing the
     *                           details for the new
     *                           user registration.
     */
    ...
    /**
     * Creates an instrumented instance of the {@code CreateUser} task. This is the
     * recommended
     * way to instantiate tasks in Serenity BDD, ensuring proper integration with
     * reporting and
     * execution.
     *
     * @param createUserRequest The {@link CreateUserRequest} containing the user's
     *                    creation
     *                    details.
    ...
    /**
     * Performs the user creation task as the given {@link Actor}. It constructs and
     * sends a
     * POST request with the user creation details to the {@code CREATE_USER}
     * endpoint.
     *
