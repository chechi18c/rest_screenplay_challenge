...
public class EnvironmentConfig {
    ...
    /**
     * Retrieves the API key for the currently active environment. The 'api.key' property is
     * typically defined within the 'environments' section of the 'serenity.conf' file (e.g.,
     * 'environments.default.api.key').
     *
     * @return The API key as a String.
     */
    public static String getApiKey() {
        return EnvironmentSpecificConfiguration.from(variables).getProperty("api.key");
    }
